...
export default function AuthPage() {
    ...
    const url = 'https://009d1d9a-89c0-4823-8e6f-3a834072fc76-00-13687tvavm746.sisko.replit.dev'
            ...
            <Col sm={6} className='p-4'>
                ...
                <Col sm={5} className='d-grid gap-2'>
                    ...
                    <p style={{ fontSize: '12px' }}>
                        By signing up, you agree to the T&C and Privacy Policy
                    </p>
                ...
                >
                    <Modal.Body>
                        <h2 className='mn-4' style={{ fontWeight: 'bold' }}>
                            {modalShow === 'SignUp'
                                ? 'Create yr account'
                                : 'Log in to yr account'}
                        </h2>
                        <Form
                            className='d-grid gap-2 px-5'
                            onSubmit={modalShow === 'SignUp' ? handleShowSignUp : handleLogin}
                        >
